let users = {
  sarahedo: {
    id: 'sarahedo',
    name: 'Sarah Edo',
    avatarURL: 'http://svitlanalesiv.me/udacity-img/female.png',
    answers: {
  ...
  tylermcginnis: {
    id: 'tylermcginnis',
    name: 'Tyler McGinnis',
    avatarURL: 'http://svitlanalesiv.me/udacity-img/male.png',
    answers: {
  ...
  johndoe: {
    id: 'johndoe',
    name: 'John Doe',
    avatarURL: 'http://svitlanalesiv.me/udacity-img/cat.png',
    answers: {
